...
class SentimentBalancer(PreprocessorBase):
    ...
    This class is compatible with scikit-learn's pipeline approach and handles
    the text data directly, assuming the sentiment labels are passed separately to fit.
    """
    ...
    def transform(self, X):
        ...
        if X == self.original_X_:
            ...
            # Return the balanced version for the pipeline
            logger.info(f"Returning {len(result_X)} samples after balancing")
